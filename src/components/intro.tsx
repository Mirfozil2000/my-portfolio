  ...
  return (
    ...
    >
      ...
      <h1 className="mb-10 mt-4 px-4 text-2xl sm:text-4xl">
        <span className="font-medium !leading-[1.5] ">Mirfozil Nabiyev</span>{" "}
        <p className="text-[14px]">
        Full-Stack Engineer with 3+ year experience.
        </p>
      </h1>
      </Fade>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/mirfozil-nabiyev-683404209/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Mirfozil2000"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
